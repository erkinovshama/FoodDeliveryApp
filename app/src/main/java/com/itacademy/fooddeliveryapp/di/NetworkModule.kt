...
import com.itacademy.fooddeliveryapp.data.retrofit.*
...
fun provideRetrofit(authInterceptor: AuthInterceptor): Retrofit {
    return Retrofit.Builder().baseUrl(AppConstants.CUSTOM_BASE_URL).client(provideOkHttpClient(authInterceptor))
