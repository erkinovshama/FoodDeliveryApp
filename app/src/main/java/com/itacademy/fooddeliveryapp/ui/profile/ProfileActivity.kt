package com.itacademy.fooddeliveryapp.ui.profile
...
import com.itacademy.fooddeliveryapp.data.model.UserModel
import com.itacademy.fooddeliveryapp.databinding.ActivityProfileBinding
import com.itacademy.fooddeliveryapp.databinding.BottomSheetVerifyOtpBinding
...
class ProfileActivity : AppCompatActivity(), PlacePickerDialog.PlaceClickListener {
    ...
    private fun initView() {
        ...
        binding.textAddressName.text = preferencesHelper.getPlace()?.name
    ...
    private fun setListener() {
        ...
        binding.layoutChooseAddress.setOnClickListener {
    ...
    override fun onPlaceClick(place: PlaceModel) {
        selectedPlace = place
        binding.textAddressName.text = place.name
    }
    ...
    private fun sendOtp(number: String) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
            "+996$number", // Phone number to verify
            60, // Timeout duration
