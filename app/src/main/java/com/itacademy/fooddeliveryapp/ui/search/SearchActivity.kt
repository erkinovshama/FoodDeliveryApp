...
import com.itacademy.fooddeliveryapp.databinding.ActivitySearchBinding
...
class SearchActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun initView() {
        ...
        if (isGlobalSearch) {
            ...
            val text =
                "<font color=#000000>Search your favourite</font> <font color=#FF4141>dish</font> <font color=#000000>in </font> <font color=#FF4141>$shopName</font>"
            binding.titleSearch.text = Html.fromHtml(text)
