...
import com.itacademy.fooddeliveryapp.databinding.ItemShopBinding
import com.squareup.picasso.Picasso
import java.text.SimpleDateFormat
import java.util.*

class ShopAdapter(private val context: Context, private val shopList: List<ShopConfigurationModel>, private val listener: OnItemClickListener) : RecyclerView.Adapter<ShopAdapter.ShopViewHolder>() {
